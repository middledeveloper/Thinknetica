...
class UI
  ...
  def create_station
    ...
    puts 'Перечень станций железной дороги:'
    puts station_repo.each { |s| puts s.name }
  end
  ...
  def create_train
    ...
    puts 'Перечень поездов железной дороги:'
    puts train_repo.each { |t| puts t.number }
  end
